...
public class IssueJsonV1 extends BaseStamp{
    ...
    */
    ...
    {        
        if(!isToken)
            issue = new mx.com.sw.services.issue.IssueJson(settings.getUrlSW(), settings.getUserSW(), settings.getPasswordSW(), null, 0);
        else
            issue = new mx.com.sw.services.issue.IssueJson(settings.getUrlSW(), settings.getTokenSW(),  null, 0);     
    }
    ...
    public StampResponseV1 StampResponseV1(String fileName, String stampVersion, boolean signed,
            boolean isBase64) throws ServicesException {
                return issue.timbrarV1(settings.getJsonCFDI(fileName, isBase64));
    }
    ...
    public StampResponseV2 StampResponseV2(String fileName, String stampVersion, boolean signed,
            boolean isBase64) throws ServicesException {
                return issue.timbrarV2(settings.getJsonCFDI(fileName, isBase64));
    }
    ...
    public StampResponseV3 StampResponseV3(String fileName, String stampVersion, boolean signed,
            boolean isBase64) throws ServicesException {
                return issue.timbrarV3(settings.getJsonCFDI(fileName, isBase64));
    }
    ...
    public StampResponseV4 StampResponseV4(String fileName, String stampVersion, boolean signed,
            boolean isBase64) throws ServicesException {
                return issue.timbrarV4(settings.getJsonCFDI(fileName, isBase64));
    }    
}
