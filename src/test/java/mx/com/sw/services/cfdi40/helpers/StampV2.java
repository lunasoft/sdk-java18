...
public class StampV2 extends BaseStamp {
    ...
    */
    public StampV2(Boolean isToken) throws ServicesException {
        if (!isToken) {
            stamp = new mx.com.sw.services.stamp.StampV2(getSettings().getUrlSW(), getSettings().getUserSW(),
                getSettings().getPasswordSW(), null, 0);
        } else {
            stamp = new mx.com.sw.services.stamp.StampV2(getSettings().getUrlSW(), getSettings().getTokenSW(), null, 0);
        }
    }
