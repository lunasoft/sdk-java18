...
public class LeyendasFiscales11Test {
    ...
    /**
    * Timbrado de CFDI versión 4.0 de tipo ingreso con complemento de leyendas fiscales mediante el
    ...
    */
    ...
    public void testStampV1LeyendasFiscalesResponseV1() {
        try {
            StampResponseV1 response = stampService.stampResponseV1(
                "resources/CFDI40/LeyendasFiscales11/CFDI40_LeyendasFiscales.xml",
                "V1", true, false);
    ...
    /**
    * Timbrado de CFDI versión 4.0 de tipo ingreso con complemento de leyendas fiscales mediante el servicio de
    * timbrado versión 2 de la librería sdk-java18 mediante usuario y contraseña con respuesta versión 2.
    */
    @Test
    ...
    */
    ...
    /**
    * Timbrado de CFDI versión 4.0 de tipo ingreso con complemento de leyendas fiscales mediante el
    * servicio de timbrado versión 2 sin sellar (Issue) de la librería sdk-java18 mediante usuario y
    ...
    */
    ...
    /**
    * Timbrado de CFDI versión 4.0 de tipo ingreso con complemento de leyendas fiscales mediante el servicio
    * de timbrado versión sin sellar (Issue) de la librería sdk-java18 mediante usuario y contraseña con
    * respuesta versión 4.
    */
    @Test
    ...
    /**
    * Timbrado de CFDI versión 4.0 de tipo ingreso con complemento de leyendas fiscales mediante el
    * servicio de timbrado versión 1 (Json) de la librería sdk-java18 mediante usuario y contraseña
    * con respuesta versión 3.
    */
    @Test
    public void testIssueJsonV1LeyendasFiscalesResponseV3() {
        try {
            StampResponseV3 response = stampService.stampResponseV3(
                "resources/CFDI40/LeyendasFiscales11/CFDI40_LeyendasFiscales.json",
    ...
    /**
    * Timbrado de CFDI versión 4.0 de tipo ingreso con complemento de leyendas fiscales mediante
    * el servicio de timbrado versión 4 (Json) de la librería sdk-java18 mediante usuario y contraseña
