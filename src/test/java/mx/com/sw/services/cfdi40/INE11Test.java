...
public class INE11Test {
    ...
    /**
    * Timbrado de CFDI versión 4.0 de tipo ingreso con complemento INE mediante el servicio de timbrado versión 1
    * de la librería sdk-java18 mediante usuario y contraseña con respuesta versión 1.
    */
    @Test
    public void testStampV1INEResponseV1() {
        try {
            StampResponseV1 response = stampService.stampResponseV1("resources/CFDI40/INE11/CFDI40_INE.xml",
                "V1", true, false);
    ...
    /**
    * Timbrado de CFDI versión 4.0 de tipo ingreso con complemento INE mediante el servicio de timbrado versión 2
    * de la librería sdk-java18 mediante usuario y contraseña con respuesta versión 2.
    */
    @Test
    public void testStampV2INEResponseV2() {
        try {
            StampResponseV2 response = stampService.stampResponseV2("resources/CFDI40/INE11/CFDI40_INE.xml",
                "V2", true, false);
            Assertions.assertNotNull(response);
            Assertions.assertNotNull(response.getData());
            Assertions.assertNotNull(response.getStatus());
    ...
    /**
    * Timbrado de CFDI versión 4.0 de tipo ingreso con complemento INE mediante el servicio de timbrado versión 4
    ...
    */
    ...
    public void testStampV4INEResponseV3B64() {
        try {
            StampResponseV3 response = stampService.stampResponseV3("resources/CFDI40/INE11/CFDI40_INE.xml",
                "V4", true, true);
            Assertions.assertNotNull(response);
            Assertions.assertNotNull(response.getData());
            Assertions.assertNotNull(response.getStatus());
    ...
    */
    ...
    public void testIssueV1INEResponseV4() {
        try {
            StampResponseV4 response = stampService.stampResponseV4("resources/CFDI40/INE11/CFDI40_INE.xml",
                "IssueV1", false, false);
            Assertions.assertNotNull(response);
            Assertions.assertNotNull(response.getData());
            Assertions.assertNotNull(response.getStatus());
    ...
    */
    ...
    /**
    * Timbrado de CFDI versión 4.0 de tipo ingreso con complemento INE mediante el servicio de timbrado versión 1 (Json)
    * de la librería sdk-java18 mediante usuario y contraseña con respuesta versión 3.
    */
    @Test
    public void testIssueJsonV1INEResponseV3() {
        try {
            StampResponseV3 response = stampService.stampResponseV3("resources/CFDI40/INE11/CFDI40_INE.json",
    ...
    /**
    * Timbrado de CFDI versión 4.0 de tipo ingreso con complemento INE mediante el servicio de timbrado versión 4 (Json)
    * de la librería sdk-java18 mediante usuario y contraseña con respuesta versión 4.
    */
    @Test
    public void testIssueJsonV4INEResponseV4() {
        try {
            StampResponseV4 response = stampService.stampResponseV4("resources/CFDI40/INE11/CFDI40_INE.json",
