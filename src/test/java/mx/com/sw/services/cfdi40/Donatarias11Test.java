...
public class Donatarias11Test {
    ...
    /**
    * Timbrado de CFDI versión 4.0 de tipo ingreso con complemento donatarias mediante el servicio de timbrado versión 1
    ...
    */
    ...
    public void testStampV1DonatariasaResponseV1() {
        try {
            StampResponseV1 response = stampService.stampResponseV1(
                "resources/CFDI40/Donatarias11/CFDI40_Donatarias.xml",
                "V1", true, false);
    ...
    /**
    * Timbrado de CFDI versión 4.0 de tipo ingreso con complemento donatarias mediante el servicio de timbrado versión 2
    ...
    */
    ...
    /**
    * Timbrado de CFDI versión 4.0 de tipo ingreso con complemento donatarias mediante el servicio de timbrado versión 4
