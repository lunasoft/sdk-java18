...
public class IssueV2 extends BaseStamp{
    ...
    private final mx.com.sw.services.issue.IssueV2 issue;
    ...
    */
    public IssueV2(Boolean isToken) throws ServicesException
    {        
        if(!isToken)
            issue = new mx.com.sw.services.issue.IssueV2(settings.getUrlSW(), settings.getUserSW(), settings.getPasswordSW(), null, 0);
        else
            issue = new mx.com.sw.services.issue.IssueV2(settings.getUrlSW(), settings.getTokenSW(),  null, 0);     
    }
