...
public class IssueV2 extends BaseStamp {
    ...
    */
    public IssueV2(Boolean isToken) throws ServicesException {
        if (!isToken) {
            issue = new mx.com.sw.services.issue.IssueV2(getSettings().getUrlSW(), getSettings().getUserSW(),
                getSettings().getPasswordSW(), null, 0);
        } else {
            issue = new mx.com.sw.services.issue.IssueV2(getSettings().getUrlSW(), getSettings().getTokenSW(), null, 0);
        }
    }
