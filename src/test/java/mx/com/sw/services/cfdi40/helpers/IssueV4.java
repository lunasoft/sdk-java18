...
public class IssueV4 extends BaseStamp {
    ...
    */
    public IssueV4(Boolean isToken) throws ServicesException {
        if (!isToken) {
            issue = new mx.com.sw.services.issue.IssueV4(getSettings().getUrlSW(), getSettings().getUserSW(),
                getSettings().getPasswordSW(), null, 0);
        } else {
            issue = new mx.com.sw.services.issue.IssueV4(getSettings().getUrlSW(), getSettings().getTokenSW(), null, 0);
        }
    }
