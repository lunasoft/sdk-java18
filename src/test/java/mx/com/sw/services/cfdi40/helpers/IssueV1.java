...
public class IssueV1 extends BaseStamp{
    ...
    */
    ...
    {        
        if(!isToken)
            issue = new mx.com.sw.services.issue.Issue(settings.getUrlSW(), settings.getUserSW(), settings.getPasswordSW(), null, 0);
        else
            issue = new mx.com.sw.services.issue.Issue(settings.getUrlSW(), settings.getTokenSW(),  null, 0);     
    }
