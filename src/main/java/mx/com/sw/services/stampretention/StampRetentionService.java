...
public abstract class StampRetentionService extends Services {
    ...
    */
    protected StampRetentionService(String url, String token, String proxy, int proxyPort) throws ServicesException {
    ...
    * @throws ServicesException exception en caso de error.
    */
    protected StampRetentionService(String url, String user, String password, String proxy,
    ...
    /**
     * Realiza el timbrado de un documento de retención dada la configuracion.
