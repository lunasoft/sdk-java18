...
public class Issue extends BaseStamp {
    ...
    */
    public Issue(String url, String token, String proxy, int proxyPort) throws ServicesException {
    ...
    * @throws ServicesException exception en caso de error.
    */
    public Issue(String url, String user, String password, String proxy, int proxyPort) throws ServicesException {
