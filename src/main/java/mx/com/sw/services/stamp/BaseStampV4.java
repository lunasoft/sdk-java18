...
public abstract class BaseStampV4 extends StampService {
    ...
    public StampResponseV1 TimbrarV1(String xml, boolean isBase64){
        ...
        try {
            ...
            String path = String.format("v4/cfdi33/%s/%s/%s", operation, "v1", format);
    ...
    public StampResponseV2 TimbrarV2(String xml, boolean isBase64){
        ...
        try {
            ...
            xml = this.getMultipartBody(xml, boundary);
            RequestConfig config = GeneralHelpers.setProxyAndTimeOut(getProxy(), getProxyPort());
            String path = String.format("v4/cfdi33/%s/%s/%s", operation, "v2", format);
    ...
    public StampResponseV3 TimbrarV3(String xml, boolean isBase64){
        ...
        try {
            ...
            xml = this.getMultipartBody(xml, boundary);
            RequestConfig config = GeneralHelpers.setProxyAndTimeOut(getProxy(), getProxyPort());
            String path = String.format("v4/cfdi33/%s/%s/%s", operation, "v3", format);
    ...
    public StampResponseV4 TimbrarV4(String xml, boolean isBase64){
        ...
        try {
            ...
            xml = this.getMultipartBody(xml, boundary);
            RequestConfig config = GeneralHelpers.setProxyAndTimeOut(getProxy(), getProxyPort());
            String path = String.format("v4/cfdi33/%s/%s/%s", operation, "v4", format);
