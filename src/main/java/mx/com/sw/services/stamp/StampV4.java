...
public class StampV4 extends BaseStampV4 {
    ...
    */
    public StampV4(String url, String user, String password, String proxy, int proxyPort) throws ServicesException {
    ...
    * @throws ServicesException exception en caso de error.
    */
    public StampV4(String url, String token, String proxy, int proxyPort) throws ServicesException {
